...
WebUI.click(findTestObject('Object Repository/Page_MyTower/a_Paramtres_ngb-nav-1'))

WebUI.click(findTestObject('Object Repository/Page_MyTower/span_Compliance Matrix_fa fa-cog'))

WebUI.click(findTestObject('Object Repository/Page_MyTower/span_Ma communaut'))
